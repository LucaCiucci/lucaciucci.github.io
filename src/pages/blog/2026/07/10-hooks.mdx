...
date: 2026-07-10
subtitle: A small Rust pattern I reached for while building c-rusted-rs and a toy reactive framework.
image: /projects/c-rusted-rs/perfetto-ui-2.png
imageAlt: >-
  Profiling screenshot from the `c-rusted-rs` project, showing how the dependency structure emerges cleanly even from the profiling data.
description: |
  In this post, I describe a small Rust pattern I reached for while building `c-rusted-rs` and a toy reactive framework. It is based on a small context object that is extended through capability-specific extension traits.
tags:
- Rust
- Architecture
- Static Analysis
