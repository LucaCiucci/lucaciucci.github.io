...
image: /projects/c-rusted-rs/leapfrog.png
...
<Callout variant="warning" id="c-rusted-aliasing-limitation">
  ...
  <Callout variant="important">
    ...
    This is a useful rule, but it is not enough to recover Rust-like guarantees. For example, even if `a` and `b` have the different types, they could still alias the same memory indirectly so this rule does not help at all in the general case and should not be relied on for a C-rusted specification or production-grade checker.
  </Callout>
</Callout>
